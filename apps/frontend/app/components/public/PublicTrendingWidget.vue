  ...
  <div v-if="item" class="rounded-2xl overflow-hidden border shadow-lg transition-all bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 hover:border-amber-500/40">
    <NuxtLink :to="getArticleUrl(item)">
      <div class="relative h-28 w-full bg-gray-900 cursor-pointer">
        ...
        <span class="absolute top-2.5 left-2.5 text-[9px] font-mono uppercase tracking-wider font-bold px-2 py-0.5 rounded-full bg-amber-500 text-white shadow flex items-center gap-1">
          <UIcon name="i-heroicons-fire" class="w-3 h-3 text-white" /> Relevant News
        </span>
      </div>
    </NuxtLink>
    <div class="p-3.5">
